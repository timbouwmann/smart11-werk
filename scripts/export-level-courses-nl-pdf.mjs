...
const outputPath = path.join(__dirname, '..', 'Smart11', 'html_pages', 'level-courses-nl.pdf');
...
await page.goto('http://localhost:3000/Smart11/html_pages/level-courses-nl.html', {
