...
const outputPath = path.join(__dirname, '..', 'Smart11', 'html_pages', 'ebook-smart11-base-v3.pdf');
...
await page.goto('http://localhost:3000/Smart11/html_pages/ebook-smart11-base-v3.html', {
